...
const navItems: NavItem[] = [
  ...
  { id: 'rfq-list', label: 'RFQs', icon: FileText, roles: ['procurement', 'admin'] },
  { id: 'quotations', label: 'Compare Quotes', icon: MessageSquare, roles: ['procurement', 'admin', 'manager'] },
  { id: 'approvals', label: 'Approvals', icon: CheckSquare, roles: ['procurement'] },
  { id: 'purchase-orders', label: 'Purchase Orders', icon: ShoppingCart, roles: ['procurement', 'admin'] },
  { id: 'invoices', label: 'Invoices', icon: Receipt, roles: ['procurement', 'admin'] },
