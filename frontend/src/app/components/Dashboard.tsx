        ...
        {role !== 'procurement' && (
          <>
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium text-white transition-all hover:opacity-90 disabled:opacity-60"
      ...
      <motion.div
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            <span className="flex items-center gap-1.5 text-xs text-[#527270]">
              <span className="w-8 h-0.5 bg-[#004643] inline-block rounded-full" />
              Spend
            </span>
          </div>
        </div>
        <ResponsiveContainer width="100%" height={220}>
          <AreaChart data={monthlyData} margin={{ top: 4, right: 4, left: 4, bottom: 0 }}>
            <CartesianGrid strokeDasharray="3 3" stroke="#D8EDEB" vertical={false} />
            ...
            <Area
              ...
              fill="#004643"
              fillOpacity={0.08}
              dot={{ r: 3, fill: '#004643', stroke: '#fff', strokeWidth: 1.5 }}
              activeDot={{ r: 5, fill: '#004643', stroke: '#fff', strokeWidth: 2 }}
